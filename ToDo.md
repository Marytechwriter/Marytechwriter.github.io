...
# Markdown
These are exercise bits from Markdown course. I am using Atom text editor. Not all the Markdown from the course is working or working as expected in this git environment. I have the [Git Markdown Course](https://lab.github.com/githubtraining/communicating-using-markdown) booked marked on my to do list.
